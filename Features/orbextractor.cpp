...
void ORBextractor::detect(InputArray image, vector<KeyPoint>& keypoints, InputArray mask)
{
    cv::Mat descriptors;
    this->operator()(image, mask, keypoints, descriptors);
}

void ORBextractor::compute(InputArray image, vector<KeyPoint>& keypoints, OutputArray descriptors)
{
    this->operator()(image, cv::noArray(), keypoints, descriptors);
}

void ORBextractor::detectAndCompute(InputArray image, InputArray mask, vector<KeyPoint>& keypoints, OutputArray descriptors, bool useProvidedKeypoints)
{
    this->operator()(image, mask, keypoints, descriptors);
}
